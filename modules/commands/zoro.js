...
module.exports.handleReply = async function ({ api, event, handleReply }) {
	...
	if (isNaN(num)) msg = "رد على الرسالة برقم العنوان لاظهار الاوامر";
      ...
      msg += `\n✎﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏`
			msg += `\n\n↞ALI تم تطويره بواسطة ${command_config.credits} `;
		} else {
			check = true;
			let count = 0;
...
⇃𖤍⇂\n`;
			...
			msg += "\n\n╭───𝒚ALI───╮\n        انت الان في قائمة الاوامر حسب الفئة \n╰───ALI───╯ رد على الرسالة برقم الامر لعرض  تفاصيل الأمر وكيفية استخدام الأمر ";
		}
	}
...
⇃𖤍⇂`;
			...
			msg +=``
			msg += "\n╭───ALI───\n       انت الان في قائمة الاوامر حسب الفئة \n───ALI───╯رد على الرسالة برقم الامر لعرض تفاصيل الأمر وكيفية استخدام الأمر، اكتب اسم الامر لعرض تفاصيل استخدامه";
		}
		var msgg = {body: msg, attachment: imgP}
...
⇃𖤍⇂${index_start+=1}🖤🪽➾✧༺${commandGroup.group.toUpperCase()}༻✧`);
		msg += `\n\nالصفحة༺${page_num_input || 1}/${page_num_total}༻`;
		msg +=``
		msg += `\n╭───ALI───\n       انت الان في قائمة الفئات \n───ALI───╯ قم بالرد على الرسالة برقم احدى الفئات المتاحة لكي يظهر لك الاوامر التي تحتويها تلك الفئة `;
	}
	var msgg = {body: msg, attachment: imgP}
