...
const fs = global.nodemodule["fs-extra"];
  ...
  "https://i.imgur.com/uXWLBeC.jpeg",
    ...
    "https://i.imgur.com/B50Pi6m.jpeg",
      ...
      "https://i.imgur.com/J2EG5QV.jpe g",
...
var min = Math.floor(Math.random() * 2);
  ...
  var money = data.money
   ...
   var callback = () => api.sendMessage({body:`هذه الصورة التي قام بها السيد ماركو\n\n-1000 عفوا الدولار 😬`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"), event.messageID); 
