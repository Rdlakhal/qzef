...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl = ["انا أتدرب الان اتقلع من امامي","ماذا هناك يا باكا","اوجعت راسي خـذ إِيــمـَـا الــهَــلاَك اْلــمـُـقـَـدسَ","أتعلم ان لوفي لديه القدرة ليلتهم المجموعة كلها هاهاها","هوي هوي ماذا تريد يا أيها الفتى اللعين","هل هذاا الشخص اللعين لا يصمت اوجع رأسي بنباحه","هل تريد ان تهلك قبل موعدك","حسنا فقط توقف عن النباح هاهاها ماذا هناك"];
  ...
  if ((event.body.toLowerCase() == "نامو") || (event.body.toLowerCase() == "اصنام")) {
   ...
   if ((event.body.toLowerCase() == "مح") || (event.body.toLowerCase() == "بوسه")) {
     return api.sendMessage("لا اصدق بعض العاهرات هنا انقلعن", threadID);
   };
   ...
   if ((event.body.toLowerCase() == " سنجل") || (event.body.toLowerCase() == "ليس لدي أحد")) {
